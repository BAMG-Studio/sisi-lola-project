...
def test_basic_generation():
    ...
    print("[TEST] Testing basic generation...")
...
def test_multilingual():
    ...
    print("[TEST] Testing multilingual generation...")
    ...
    print(f"[EN] English: {en_response}\n")
    ...
    print(f"[YO] Yoruba: {yo_response}\n")


def test_personality_chat():
    """Test personality-driven chat"""
    print("[TEST] Testing personality chat...")
